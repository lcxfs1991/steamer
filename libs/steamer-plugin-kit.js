...
function install(opts) {
	...
	try {
		...
		throw("The kit " + kit + " is not installed");
	}
...
module.exports = function() {
	let kit = prefix + argv.kit,
		kitPath = path.join(node_modules, kit),
		folder = (argv._.length) ? argv._[0] : kit,
		localConfigFile = path.join(folder, ".steamer/" + kit + ".js"),
